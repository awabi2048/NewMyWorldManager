...
object MwmMenuActionSemantics {
    ...
    private val entries = listOf(
        ...
        Entry("bedrock-favorite-group-invites", "BedrockMenuService.kt", "toggle_favorite_group_invites", MenuActionSafety.REVERSIBLE, MwmReversibleContracts.USER_SETTINGS_PROVIDER, "favorite_group_invites", "favorite group invite reception mutation"),
        ...
        Entry("user-favorite-group-invites", "UserSettingsGui.kt", "favorite_group_invites", MenuActionSafety.REVERSIBLE, MwmReversibleContracts.USER_SETTINGS_PROVIDER, "favorite_group_invites", "favorite group invite reception mutation"),
